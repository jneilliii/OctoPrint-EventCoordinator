...
$(function() {
    function EventcoordinatorViewModel(parameters) {
        ...
        self.event_details = function(data) {
            if (data === false) {
                return {'event': ko.observable(''), 'command': ko.observable(''), 'type': ko.observable(''), 'enabled': ko.observable(true), 'debug': ko.observable(false)};
            } else {
        ...
        self.addEvent = function() {
            ...
            self.settingsViewModel.settings.plugins.eventcoordinator.subscriptions.push(self.selected_command());
        ...
        self.removeEvent = function(data) {
            self.settingsViewModel.settings.plugins.eventcoordinator.subscriptions.remove(data);
        };
    }
    ...
    OCTOPRINT_VIEWMODELS.push({
        ...
        elements: ["#settings_plugin_eventcoordinator"]
    });
});
